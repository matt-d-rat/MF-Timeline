...
= 1.1.3 =
* Fixed a major error which was caused by calling a object property in a static context. See [issue #2](https://github.com/matt-d-rat/MF-Timeline/issues/2 "MF Timeline Repository").
